...
public class Serial implements SerialPortEventListener {
	...
	Arduino.SerialProxy serialProxy;
	...
	/**
	 * @param serialProxy typically use "this"
	 */
	public Serial(Arduino.SerialProxy serialProxy) {
		this(serialProxy, dname, drate, dparity, ddatabits, dstopbits);
	}
	
	/**
	 * @param irate 9600 is the default
	 */
	public Serial(Arduino.SerialProxy serialProxy, int irate) {
		this(serialProxy, dname, irate, dparity, ddatabits, dstopbits);
	}

	/**
	 * @param iname name of the port (COM1 is the default)
	 */
	public Serial(Arduino.SerialProxy serialProxy, String iname, int irate) {
		this(serialProxy, iname, irate, dparity, ddatabits, dstopbits);
	}

	public Serial(Arduino.SerialProxy serialProxy, String iname) {
		this(serialProxy, iname, drate, dparity, ddatabits, dstopbits);
	}
	...
	public Serial(Arduino.SerialProxy serialProxy, String iname, int irate,
		...
		try {
			serialEventMethod =
				serialProxy.getClass().getMethod("serialEvent",
					...
					synchronized (buffer) {
						...
						if (serialEventMethod != null) {
							if ((bufferUntil &&
								...
								try {
									serialEventMethod.invoke(serialProxy, new Object[] { this });
								} catch (Exception e) {
